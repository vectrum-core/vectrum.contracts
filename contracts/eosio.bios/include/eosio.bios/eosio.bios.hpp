 ...
 * VECTRUM CONTRACTS
 *
 * The design of the VECTRUM blockchain calls for a number of smart contracts that are run at a
 ...
 * managing, and/or using an VECTRUM blockchain. They are provided for reference purposes:
 * - eosio.bios
 * - eosio.system
 * - eosio.msig
 * - eosio.wrap
