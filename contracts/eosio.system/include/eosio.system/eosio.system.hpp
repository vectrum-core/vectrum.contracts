...
namespace eosiosystem {
   ...
   static constexpr int64_t  useconds_per_month    = int64_t(seconds_per_month) * 1000'000ll;
   ...
   static constexpr int64_t  min_activated_stake   = 150'000'000'0000; // 15% from 1 billion
   static constexpr int64_t  ram_gift_bytes        = 1400;
   static constexpr uint32_t refund_delay_sec      = 3 * seconds_per_day;

   static constexpr int64_t  inflation_precision   = 100;   // 2 decimals
   static constexpr int64_t  default_rate          = 3000;   // 30% annual rate
   static constexpr int64_t  pay_factor_precision  = 10000;
   static constexpr int64_t  default_bpay_factor   = 100000; // 10000 / 100000 = 10%
   static constexpr int64_t  default_vpay_factor   = 100000; // 10000 / 100000 = 10%
   static constexpr int64_t  default_upay_factor   = 12500;  // 10000 / 12500  = 80%
   ...
   struct [[eosio::table("global"), eosio::contract("eosio.system")]] eosio_global_state : eosio::blockchain_parameters {
      ...
      time_point           last_buckets_fill;
      int64_t              bpay_bucket = 0;
      int64_t              vpay_bucket = 0;
      int64_t              upay_bucket = 0;
      uint32_t             total_unpaid_blocks = 0;
      int64_t              total_activated_stake = 0;
      time_point           thresh_activated_stake_time;
      uint16_t             last_producer_schedule_size = 0;
      double               total_producer_vote_weight = 0;
      double               total_user_vote_weight = 0;
      block_timestamp      last_name_close;

      // explicit serialization macro is not necessary, used here only to improve compilation time
      EOSLIB_SERIALIZE_DERIVED( eosio_global_state, eosio::blockchain_parameters,
         (max_ram_size)(total_ram_bytes_reserved)(total_ram_stake)
         (last_producer_schedule_update)(last_buckets_fill)
         (bpay_bucket)(vpay_bucket)(upay_bucket)(total_unpaid_blocks)(total_activated_stake)(thresh_activated_stake_time)
         (last_producer_schedule_size)(total_producer_vote_weight)(total_user_vote_weight)(last_name_close)
      )
   };
   ...
   struct [[eosio::table("global4"), eosio::contract("eosio.system")]] eosio_global_state4 {
      ...
      EOSLIB_SERIALIZE( eosio_global_state4, (continuous_rate)(bpay_factor)(vpay_factor)(upay_factor) )
   };
   ...
   class [[eosio::contract("eosio.system")]] system_contract : public native {
      ...
      public:
         ...
         static constexpr eosio::name vectrum_account{"vectrum"_n};
         ...
         [[eosio::action]]
         void unactivprod( const name& producer );
         ...
         using activprod_action = eosio::action_wrapper<"activprod"_n, &system_contract::activprod>;
         using unactivprod_action = eosio::action_wrapper<"unactivprod"_n, &system_contract::unactivprod>;
      ...
      private:
         ...
         static double get_continuous_rate(int64_t timePassedAfterActivation);
